...
![Diagrama de Sequência](../Assets/modelagem/diagramaSequencia/sequencia1.png)
<h6 align = "center">Figura 3: Diagrama de sequência - Devolução de produto</h6>


![Diagrama de Sequência](../Assets/modelagem/diagramaSequencia/sequencia2.png)
<h6 align = "center">Figura : Diagrama de sequência - Troca de produto</h6>
...
[Diagrama de Sequência](/Modelagem/DiagramaSequencia.md): O diagrama de sequência ilustra a dinâmica do sistema, destacando as interações entre os diferentes objetos ao longo do tempo. No contexto da troca e devolução, o diagrama de sequência pode representar a jornada do cliente desde a solicitação até a conclusão do processo. Inicialmente, o cliente inicia uma solicitação de troca ou devolução, desencadeando uma sequência de eventos que envolvem a validação do pedido, a verificação do estado do produto e a atualização do sistema com a informação de retorno.


&emsp;&emsp;A visão lógica da arquitetura integra esses elementos, destacando a organização modular do sistema para garantir flexibilidade e escalabilidade. Módulos como "Gestão de Pedidos", "Gestão de Estoque" e "Processamento de Devolução" desempenham papéis cruciais na lógica do sistema. A integração entre esses módulos é facilitada por interfaces bem definidas e protocolos de comunicação eficientes.
...
| 1.2    | Adição do diagrama de implantação | Gabriel Ribeiro |   Carlos Eduardo  | 01/12/2023   | Carlos Eduardo        |
| 2.0    | Adição de artefatos e contextuaizando visões| Carlos Eduardo |   --   | 01/12/2023   | ---         |